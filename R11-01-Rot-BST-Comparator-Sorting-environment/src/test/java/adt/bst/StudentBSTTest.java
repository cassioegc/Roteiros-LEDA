...
public class StudentBSTTest {
	...
	public void testReverseOrder() {
		fillTree();
		Integer[] array = new Integer[] { 232, 76, 67, 23, 12, 9, 6, 5, 2, 0, -34, -40 };
		assertArrayEquals(((SortComparatorBSTImpl<Integer>) tree).reverseOrder(), array);
	...
	public void testSort() {
		...
		((SortComparatorBSTImpl<Integer>) tree).sort(newArray);
